...
import React, { useState, type ReactNode, useRef, useEffect, memo } from 'react'
...
export const Toggle = memo(
  ({ summary, children }: ToggleProps): React.JSX.Element => {
    ...
    useEffect(() => {
      ...
      const observerCallback = (mutationsList: any): void => {
      ...
      observer.observe(detailsElement, config)
    ...
    return (
      <details css={detailsStyle} ref={detailsRef}>
        ...
        {isOpen && (
          <>
            ...
            <div css={foldButtonStyle} onClick={close}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width={12}
                height={12}
